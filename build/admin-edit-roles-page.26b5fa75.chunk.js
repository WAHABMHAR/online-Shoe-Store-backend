(self.webpackChunkbackend=self.webpackChunkbackend||[]).push([[2544],{25545:(X,B,r)=>{"use strict";r.r(B),r.d(B,{CreatePage:()=>Ee,default:()=>$e});var e=r(67294),b=r(185),P=r(53979),R=r(11047),Z=r(29728),O=r(49066),S=r(41580),x=r(75515),D=r(11276),q=r(67819),a=r(16364),H=r(61467),p=r(80120),A=r(67109),F=r(66115),f=r(14916),C=r(27361),w=r.n(C),ue=r(41609),ae=r.n(ue),ie=r(86896),y=r(86706),le=r(16550),Y=r(1565),G=r(14900),_=r(36364),xe=r(442),me=r(87561);const oe=me.Ry().shape({name:me.Z_().required(p.I0.required),description:me.Z_().required(p.I0.required)}),Pe=Y.ZP.div`
